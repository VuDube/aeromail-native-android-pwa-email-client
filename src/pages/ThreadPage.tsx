  ...
  return (
    <div className="relative group">
      ...
      >
        ...
        <div
          className={cn(
            "prose-email text-surface-on text-sm leading-relaxed",
  ...
  return (
    <AppLayout>
      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-40">
        <header className="sticky top-0 bg-background/90 backdrop-blur-md z-[20] py-4 flex items-center justify-between border-b border-surface-variant/10 mb-8">
        ...
        <div className="fixed bottom-0 left-0 lg:left-72 right-0 p-6 z-[40] bg-gradient-to-t from-background via-background/95 to-transparent pt-12">
            ...
            <AnimatePresence mode="wait">
              {isReplying ? (
                <motion.div
                  ...
                  exit={{ y: 20, opacity: 0 }}
                  className="bg-surface-1 shadow-2xl rounded-3xl border border-primary/20 overflow-hidden"
                >
                  ...
                  <div className="px-6 py-4 border-t flex items-center justify-end bg-surface-2/30">
                    <Button
