          ...
          <AnimatePresence mode="wait">
            {isReplying ? (
              ...
              >
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-1">
                    <Button variant="ghost" size="icon" className="rounded-full h-10 w-10"><Paperclip className="h-5 w-5" /></Button>
                    <Button variant="ghost" className="text-xs" onClick={() => setIsReplying(false)}>Discard</Button>
                  </div>
                  <Button 
